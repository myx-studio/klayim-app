...
must_haves:
  ...
  key_links:
    ...
    - from: "apps/web/src/components/pages/onboarding/setup-organization/index.tsx"
      ...
      pattern: "check-name"
    - from: "apps/web/src/components/layouts/onboarding/index.tsx"
      to: "@/components/ui/stepper"
      via: "Stepper component import with stepStates prop"
...
- Stepper is imported from "@/components/ui/stepper" and import resolves successfully
- Stepper component receives stepStates prop for individual step state overrides
...
- Stepper component from Plan 01-01 is properly integrated with stepStates prop
  </done>
</task>
